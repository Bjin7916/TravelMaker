...
국내 여행지에 대한 소비자의 <strong>부정적인 인식</strong><br>
국내 유명 여행지<strong> 바가지 요금 및 부족한 서비스 질</strong>에 대한 사회적 이슈<br>
수도권에 편중된 인구 비중 -> <strong>지역 경제의 활성화 필요성</strong>
...
<h2>6. 느낀점</h2>
<h3>6-1. 어려웠던 부분</h3>
REST API 방식에 대한 이해도가 부족하여 컨트롤러와 뷰단 사이의 흐름을 이해하는데에 많은 어려움이 있었습니다.<br>
퍼블리싱 단계에서 클론 코딩이라는 특성상 동일한 형태의 페이지 또는 기능들에 대해<br>
팀원들과의 소통이 잘 안되어 동일한 역할을 하는 클래스명 또는 css들이 다른 이름으로 중복적으로 만들어진 것을 백엔드를 시작할 때 알게 되었습니다.<br>
이러한 부분에서 서로 소통하여 불필요하게 길어지는 코드를 줄일 수 있었을 텐데 라는 아쉬움이 많이 남았습니다.<br>
...
<h3>6-3. 총평</h3>
<h4>🌟 기획: 기반이 중요하다. </h4>
프로젝트를 진행하는 기간인 약 4주안에 서비스를 구현하는 것이 정말 어려웠지만, 그 중에 제일 중요한 것은 기획이라고 많이 느꼈습니다. 기획이 탄탄해야 나중에 가서 중간에 화면이나 SQL문을 수정하는 상황과 불필요한 테이블이 생기는 상황을 막을 수 있다는 것을 느꼈고, 
그 프로젝트 웹개발 완성도의 퀄리티가 기획에 따라 엄청난 차이가 난다는 것을 느꼈습니다.


<h4>🌟 협업: 끊임없는 소통과 회의는 필수! </h4>
